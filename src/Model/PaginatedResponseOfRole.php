...
/**
 * PaginatedResponseOfRole Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfRole implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfRole';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\Role[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Gets elements
     *
     * @return \Bluerain\ID4iClient\Model\Role[]
     */
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\Role[] $elements elements
     *
     * @return $this
     */
