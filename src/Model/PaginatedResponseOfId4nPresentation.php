...
/**
 * PaginatedResponseOfId4nPresentation Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfId4nPresentation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfId4nPresentation';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\Id4nPresentation[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\Id4nPresentation[] $elements elements
     *
     * @return $this
     */
