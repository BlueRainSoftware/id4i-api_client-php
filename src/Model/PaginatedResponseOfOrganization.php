...
/**
 * PaginatedResponseOfOrganization Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfOrganization implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfOrganization';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\Organization[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\Organization[] $elements elements
     *
     * @return $this
     */
