...
class DocumentUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'filename' => 'string',
        'mime_type' => 'string',
        'visibility' => '\Bluerain\ID4iClient\Model\VisibilityUpdate'
    ];
     ...
     * Gets visibility
     *
     * @return \Bluerain\ID4iClient\Model\VisibilityUpdate
     */
     ...
     * Sets visibility
     *
     * @param \Bluerain\ID4iClient\Model\VisibilityUpdate $visibility Visibility configuration
     *
     * @return $this
     */
