...
/**
 * PaginatedResponseOfApiKeyPresentation Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfApiKeyPresentation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfApiKeyPresentation';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\ApiKeyPresentation[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\ApiKeyPresentation[] $elements elements
     *
     * @return $this
     */
