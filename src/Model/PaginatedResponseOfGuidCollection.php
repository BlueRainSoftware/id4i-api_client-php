...
/**
 * PaginatedResponseOfGuidCollection Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfGuidCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfGuidCollection';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\GuidCollection[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\GuidCollection[] $elements elements
     *
     * @return $this
     */
