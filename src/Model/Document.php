...
class Document implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $owner_organization_id The organization's namespace which owns the document
     *
     * @return $this
     */
     ...
     * Sets visibility
     *
     * @param \Bluerain\ID4iClient\Model\Visibility $visibility Visibility configuration
     *
     * @return $this
     */
