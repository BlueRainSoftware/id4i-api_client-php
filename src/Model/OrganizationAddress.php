...
class OrganizationAddress implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['company_name']) && (mb_strlen($this->container['company_name']) > 254)) {
        ...
        if ((mb_strlen($this->container['city']) > 99)) {
        ...
        if (!is_null($this->container['telephone']) && (mb_strlen($this->container['telephone']) > 99)) {
    ...
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 254)) {
    ...
    {
        if (!is_null($telephone) && (mb_strlen($telephone) > 99)) {
