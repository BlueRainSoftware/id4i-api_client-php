...
/**
 * PaginatedResponseOfDocument Class Doc Comment
 *
 * @category Class
 * @package  Bluerain\ID4iClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedResponseOfDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedResponseOfDocument';
    ...
    protected static $swaggerTypes = [
        'elements' => '\Bluerain\ID4iClient\Model\Document[]',
        'limit' => 'int',
        'offset' => 'int',
        'total' => 'int'
    ];
     ...
     * Sets elements
     *
     * @param \Bluerain\ID4iClient\Model\Document[] $elements elements
     *
     * @return $this
     */
