...
class AuditingApi
{
     ...
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfChangeLogEntry
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfChangeLogEntry, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfChangeLogEntry';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfChangeLogEntry',
