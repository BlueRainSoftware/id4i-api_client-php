...
class CollectionsApi
{
    ...
    protected function addElementsToCollectionRequest($id4n, $list_of_guids)
    {
        ...
        if ($list_of_guids === null || (is_array($list_of_guids) && count($list_of_guids) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function createCollectionRequest($create_info)
    {
        ...
        if ($create_info === null || (is_array($create_info) && count($create_info) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation getMultipleProperties
     *
     * Get multiple ID4n properties
     *
     * @param  string[] $id4ns The list of ID4ns to resolve. (required)
     * @param  string $organization_id The organization namespace. (optional)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\ListOfId4nProperties
     */
    public function getMultipleProperties($id4ns, $organization_id = null)
    {
        list($response) = $this->getMultiplePropertiesWithHttpInfo($id4ns, $organization_id);
        return $response;
    }

    /**
     * Operation getMultiplePropertiesWithHttpInfo
     *
     * Get multiple ID4n properties
     *
     * @param  string[] $id4ns The list of ID4ns to resolve. (required)
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\ListOfId4nProperties, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMultiplePropertiesWithHttpInfo($id4ns, $organization_id = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\ListOfId4nProperties';
        $request = $this->getMultiplePropertiesRequest($id4ns, $organization_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\ListOfId4nProperties',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getMultiplePropertiesAsync
     *
     * Get multiple ID4n properties
     *
     * @param  string[] $id4ns The list of ID4ns to resolve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMultiplePropertiesAsync($id4ns, $organization_id = null)
    {
        return $this->getMultiplePropertiesAsyncWithHttpInfo($id4ns, $organization_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMultiplePropertiesAsyncWithHttpInfo
     *
     * Get multiple ID4n properties
     *
     * @param  string[] $id4ns The list of ID4ns to resolve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMultiplePropertiesAsyncWithHttpInfo($id4ns, $organization_id = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\ListOfId4nProperties';
        $request = $this->getMultiplePropertiesRequest($id4ns, $organization_id);
    ...
    /**
     * Create request for operation 'getMultipleProperties'
     *
     * @param  string[] $id4ns The list of ID4ns to resolve. (required)
     * @param  string $organization_id The organization namespace. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMultiplePropertiesRequest($id4ns, $organization_id = null)
    {
        // verify the required parameter 'id4ns' is set
        if ($id4ns === null || (is_array($id4ns) && count($id4ns) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id4ns when calling getMultipleProperties'
            );
        }

        $resourcePath = '/api/v1/multiple/id4ns/properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if (is_array($id4ns)) {
            $queryParams['id4ns'] = $id4ns;
        } else
        if ($id4ns !== null) {
            $queryParams['id4ns'] = ObjectSerializer::toQueryValue($id4ns);
        }
        // query params
        if ($organization_id !== null) {
            $queryParams['organizationId'] = ObjectSerializer::toQueryValue($organization_id);
