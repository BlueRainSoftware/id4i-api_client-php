...
class ApiKeysApi
{
     ...
     * @param  \Bluerain\ID4iClient\Model\AddApiKeyPrivilegeRequest $add_api_key_privilege_request addApiKeyPrivilegeRequest (required)
     *
    ...
    protected function addApiKeyPrivilegeRequest($key, $add_api_key_privilege_request)
    {
        ...
        if ($add_api_key_privilege_request === null || (is_array($add_api_key_privilege_request) && count($add_api_key_privilege_request) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \Bluerain\ID4iClient\Model\ListOfId4ns $id4ns id4ns (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    protected function addApiKeyPrivilegeForId4nsRequest($key, $privilege, $id4ns)
    {
        ...
        if ($privilege === null || (is_array($privilege) && count($privilege) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($id4ns === null || (is_array($id4ns) && count($id4ns) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Create API key
     *
     * @param  \Bluerain\ID4iClient\Model\ApiKeyCreationRequest $creation_request API key to be created. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\ApiKeyPresentation
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\ApiKeyPresentation, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\ApiKeyPresentation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function createNewApiKeyRequest($creation_request)
    {
        ...
        if ($creation_request === null || (is_array($creation_request) && count($creation_request) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilegeInfo
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilegeInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAllApiKeyPrivilegesWithHttpInfo($id4n_concerning = null, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilegeInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilegeInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPresentation
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPresentation, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAllApiKeysOfOrganizationWithHttpInfo($organization_id = null, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPresentation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPresentation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilege
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilege, HTTP status code, HTTP response headers (array of strings)
     */
    public function listApiKeyPrivilegesWithHttpInfo($key, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilege';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfApiKeyPrivilege',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfId4nPresentation
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfId4nPresentation, HTTP status code, HTTP response headers (array of strings)
     */
    public function listId4nsWithHttpInfo($key, $privilege, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfId4nPresentation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfId4nPresentation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $key key (required)
     * @param  \Bluerain\ID4iClient\Model\RemoveApiKeyPrivilegeRequest $remove_api_key_privilege_request removeApiKeyPrivilegeRequest (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    protected function removeApiKeyPrivilegeRequest($key, $remove_api_key_privilege_request)
    {
        ...
        if ($remove_api_key_privilege_request === null || (is_array($remove_api_key_privilege_request) && count($remove_api_key_privilege_request) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \Bluerain\ID4iClient\Model\ApiKeyChangeRequest $api_key_change The new values to apply. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    protected function updateApiKeyRequest($key, $api_key_change)
    {
        ...
        if ($api_key_change === null || (is_array($api_key_change) && count($api_key_change) === 0)) {
            throw new \InvalidArgumentException(
