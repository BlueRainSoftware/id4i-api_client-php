...
class HistoryApi
{
     ...
     * @param  \Bluerain\ID4iClient\Model\HistoryItem $history_item The history item to publish (required)
     *
    ...
    protected function addItemRequest($id4n, $history_item)
    {
        ...
        if ($history_item === null || (is_array($history_item) && count($history_item) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation filteredListWithHttpInfo
     *
     * List history
     *
     * @param  string $id4n GUID to retrieve the history for (required)
    ...
    /**
     * Operation filteredListAsyncWithHttpInfo
     *
     * List history
     *
     * @param  string $id4n GUID to retrieve the history for (required)
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\HistoryItem
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\HistoryItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveItemWithHttpInfo($id4n, $organization_id, $sequence_id)
    {
        $returnType = '\Bluerain\ID4iClient\Model\HistoryItem';
     ...
     * @param  string $organization_id organizationId (required)
     * @param  int $sequence_id sequenceId (required)
     * @param  \Bluerain\ID4iClient\Model\HistoryItemUpdate $update update (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\HistoryItem
     ...
     * @param  string $organization_id organizationId (required)
     * @param  int $sequence_id sequenceId (required)
     * @param  \Bluerain\ID4iClient\Model\Visibility $visibility History item visibility restrictions (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\HistoryItem
