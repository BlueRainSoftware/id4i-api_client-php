...
class RoutingApi
{
     ...
     * @return \Bluerain\ID4iClient\Model\Route[]
     */
    ...
    /**
     * Operation getAllRoutesWithHttpInfo
     *
     * Retrieve all routes of a GUID (or ID4N)
     *
     * @param  string $id4n id4n (required)
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\Route[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllRoutesWithHttpInfo($id4n, $type, $organization_id = null, $interpolate = 'true')
    {
        $returnType = '\Bluerain\ID4iClient\Model\Route[]';
    ...
    /**
     * Operation getAllRoutesAsyncWithHttpInfo
     *
     * Retrieve all routes of a GUID (or ID4N)
     *
     * @param  string $id4n id4n (required)
    ...
    /**
     * Create request for operation 'getAllRoutes'
     *
     * @param  string $id4n id4n (required)
     * @param  string $type The type of route you want to have (required)
     * @param  string $organization_id organizationId (optional)
    ...
    protected function getAllRoutesRequest($id4n, $type, $organization_id = null, $interpolate = 'true')
    {
        ...
        if ($id4n === null || (is_array($id4n) && count($id4n) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id4n when calling getAllRoutes'
            );
        }
        // verify the required parameter 'type' is set
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling getAllRoutes'
            );
        }
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\RoutingFile
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\RoutingFile, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRoutingFileWithHttpInfo($id4n, $organization_id = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\RoutingFile';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\RoutingFile',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Store routing file
     *
     * @param  \Bluerain\ID4iClient\Model\RoutingFileRequest $rfr rfr (required)
     * @param  string $id4n id4n (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function updateRoutingFileRequest($rfr, $id4n)
    {
        ...
        if ($rfr === null || (is_array($rfr) && count($rfr) === 0)) {
            throw new \InvalidArgumentException(
