...
class AccountsApi
{
     ...
     *
     * @param  \Bluerain\ID4iClient\Model\CompleteUserRegistrationRequest $complete_registration Contains the verification token, the username and the initial password. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    protected function completeRegistrationRequest($complete_registration)
    {
        ...
        if ($complete_registration === null || (is_array($complete_registration) && count($complete_registration) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\UserPresentation
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\UserPresentation, HTTP status code, HTTP response headers (array of strings)
     */
    public function findUserByUsernameWithHttpInfo($username)
    {
        $returnType = '\Bluerain\ID4iClient\Model\UserPresentation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\UserPresentation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function inviteUsersRequest($organization_id, $invitation_list)
    {
        ...
        if ($invitation_list === null || (is_array($invitation_list) && count($invitation_list) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfRole
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfRole, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAllRolesWithHttpInfo($privilege = null, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfRole';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\PaginatedResponseOfRole',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation login
     *
     * @param  \Bluerain\ID4iClient\Model\AccountCredentials $account_credentials account_credentials (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  \Bluerain\ID4iClient\Model\AccountCredentials $account_credentials (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
    ...
    protected function loginRequest($account_credentials)
    {
        ...
        if ($account_credentials === null || (is_array($account_credentials) && count($account_credentials) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Register user
     *
     * @param  \Bluerain\ID4iClient\Model\UserRegistrationRequest $user_registration The user information about the new created user. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\UserRegistrationResponse
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\UserRegistrationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerUserWithHttpInfo($user_registration)
    {
        $returnType = '\Bluerain\ID4iClient\Model\UserRegistrationResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\UserRegistrationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Bluerain\ID4iClient\Model\PasswordResetRequest $reset_request Contains the required information to request a new password. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\SimpleMessageResponse
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\SimpleMessageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestPasswordResetWithHttpInfo($reset_request)
    {
        $returnType = '\Bluerain\ID4iClient\Model\SimpleMessageResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\SimpleMessageResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function requestPasswordResetRequest($reset_request)
    {
        ...
        if ($reset_request === null || (is_array($reset_request) && count($reset_request) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \Bluerain\ID4iClient\Model\PasswordResetVerificationRequest $verification_request Contains the new password and the verification token to set the new password. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\SimpleMessageResponse
     ...
     * Verify registration
     *
     * @param  \Bluerain\ID4iClient\Model\RegistrationVerificationTokenPresentation $token The token for user verification. (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
