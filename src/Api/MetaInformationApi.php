...
class MetaInformationApi
{
     ...
     * @return \Bluerain\ID4iClient\Model\AppInfoPresentation
     */
    public function applicationInfo()
    {
        list($response) = $this->applicationInfoWithHttpInfo();
        return $response;
    }
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\AppInfoPresentation, HTTP status code, HTTP response headers (array of strings)
     */
    public function applicationInfoWithHttpInfo()
    {
        $returnType = '\Bluerain\ID4iClient\Model\AppInfoPresentation';
        $request = $this->applicationInfoRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bluerain\ID4iClient\Model\AppInfoPresentation',
     ...
     */
    public function applicationInfoAsync()
    {
        return $this->applicationInfoAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function applicationInfoAsyncWithHttpInfo()
    {
        $returnType = '\Bluerain\ID4iClient\Model\AppInfoPresentation';
        $request = $this->applicationInfoRequest();
     ...
     */
    protected function applicationInfoRequest()
    {
