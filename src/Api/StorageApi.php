...
class StorageApi
{
     ...
     * @return \Bluerain\ID4iClient\Model\Document
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\Document, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDocumentWithHttpInfo($organization_id, $id4n, $content)
    {
        $returnType = '\Bluerain\ID4iClient\Model\Document';
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\PaginatedResponseOfDocument
     */
     ...
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bluerain\ID4iClient\Model\PaginatedResponseOfDocument, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAllDocumentsWithHttpInfo($id4n, $owner = null, $offset = null, $limit = null)
    {
        $returnType = '\Bluerain\ID4iClient\Model\PaginatedResponseOfDocument';
     ...
     * @return \Bluerain\ID4iClient\Model\Document
     */
    public function putDocument($organization_id, $id4n, $content)
    {
        list($response) = $this->putDocumentWithHttpInfo($organization_id, $id4n, $content);
        return $response;
    }

    /**
     * Operation putDocumentWithHttpInfo
     *
     * Put an document for an id4n
     *
     * @param  string $organization_id organizationId (required)
     ...
     * @return array of \Bluerain\ID4iClient\Model\Document, HTTP status code, HTTP response headers (array of strings)
     */
    public function putDocumentWithHttpInfo($organization_id, $id4n, $content)
    {
        $returnType = '\Bluerain\ID4iClient\Model\Document';
        $request = $this->putDocumentRequest($organization_id, $id4n, $content);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putDocumentAsync($organization_id, $id4n, $content)
    {
        return $this->putDocumentAsyncWithHttpInfo($organization_id, $id4n, $content)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putDocumentAsyncWithHttpInfo
     *
     * Put an document for an id4n
     *
     * @param  string $organization_id organizationId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putDocumentAsyncWithHttpInfo($organization_id, $id4n, $content)
    {
        $returnType = '\Bluerain\ID4iClient\Model\Document';
        $request = $this->putDocumentRequest($organization_id, $id4n, $content);
    ...
    /**
     * Create request for operation 'putDocument'
     *
     * @param  string $organization_id organizationId (required)
     * @param  string $id4n id4n (required)
     * @param  \SplFileObject $content content (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putDocumentRequest($organization_id, $id4n, $content)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_id when calling putDocument'
            );
        }
        // verify the required parameter 'id4n' is set
        if ($id4n === null || (is_array($id4n) && count($id4n) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id4n when calling putDocument'
            );
        }
        // verify the required parameter 'content' is set
        if ($content === null || (is_array($content) && count($content) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content when calling putDocument'
            );
        }
     ...
     * @param  string $id4n id4n (required)
     * @param  string $file_name fileName (required)
     * @param  \Bluerain\ID4iClient\Model\DocumentUpdate $document document (required)
     *
     * @throws \Bluerain\ID4iClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bluerain\ID4iClient\Model\Document
