...
class GuidsApi
{
    ...
    protected function addGuidAliasRequest($id4n, $alias_type, $alias)
    {
        ...
        if ($alias_type === null || (is_array($alias_type) && count($alias_type) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function createGuidRequest($create_guid_info)
    {
        ...
        if ($create_guid_info === null || (is_array($create_guid_info) && count($create_guid_info) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function importGS1CodesRequest($import_gs1_codes_request)
    {
        ...
        if ($import_gs1_codes_request === null || (is_array($import_gs1_codes_request) && count($import_gs1_codes_request) === 0)) {
            throw new \InvalidArgumentException(
