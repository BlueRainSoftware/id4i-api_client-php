...
class GUIDsApi
{
    ...
    {
        list($response) = $this->addGuidAliasWithHttpInfo($id4n, $alias_type, $alias);
        return $response;
    }
     ...
     * @return \Swagger\Client\Model\ApiError
     */
    public function addGuidAlias1($id4n, $alias_type)
    {
        list($response) = $this->addGuidAlias1WithHttpInfo($id4n, $alias_type);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function addGuidAlias1WithHttpInfo($id4n, $alias_type)
    {
        $returnType = '\Swagger\Client\Model\ApiError';
        $request = $this->addGuidAlias1Request($id4n, $alias_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addGuidAlias1Async($id4n, $alias_type)
    {
        return $this->addGuidAlias1AsyncWithHttpInfo($id4n, $alias_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addGuidAlias1AsyncWithHttpInfo($id4n, $alias_type)
    {
        $returnType = '\Swagger\Client\Model\ApiError';
        $request = $this->addGuidAlias1Request($id4n, $alias_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addGuidAlias1Request($id4n, $alias_type)
    {
        // verify the required parameter 'id4n' is set
        if ($id4n === null) {
            throw new \InvalidArgumentException(
