...
class AccountsApi
{
     ...
     * @return bool
     */
    public function isContractRequired()
    {
        list($response) = $this->isContractRequiredWithHttpInfo();
        return $response;
    }

    /**
     * Operation isContractRequiredWithHttpInfo
     *
     * Tells you whether your company needs to have a contract with BlueRain to be able to sign up
     *
     *
     ...
     */
    public function isContractRequiredWithHttpInfo()
    {
        $returnType = 'bool';
        $request = $this->isContractRequiredRequest();
    ...
    /**
     * Operation isContractRequiredAsync
     *
     * Tells you whether your company needs to have a contract with BlueRain to be able to sign up
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function isContractRequiredAsync()
    {
        return $this->isContractRequiredAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation isContractRequiredAsyncWithHttpInfo
     *
     * Tells you whether your company needs to have a contract with BlueRain to be able to sign up
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function isContractRequiredAsyncWithHttpInfo()
    {
        $returnType = 'bool';
        $request = $this->isContractRequiredRequest();
    ...
    /**
     * Create request for operation 'isContractRequired'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function isContractRequiredRequest()
    {

        $resourcePath = '/account/contractRequired';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
