...
class RoutingApi
{
     ...
     */
    public function getRoute($id4n, $type, $private_routes = null, $public_routes = null)
    {
        list($response) = $this->getRouteWithHttpInfo($id4n, $type, $private_routes, $public_routes);
        return $response;
    }
     ...
     */
    public function getRouteWithHttpInfo($id4n, $type, $private_routes = null, $public_routes = null)
    {
        $returnType = '\Swagger\Client\Model\Route';
        $request = $this->getRouteRequest($id4n, $type, $private_routes, $public_routes);
     ...
     */
    public function getRouteAsync($id4n, $type, $private_routes = null, $public_routes = null)
    {
        return $this->getRouteAsyncWithHttpInfo($id4n, $type, $private_routes, $public_routes)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRouteAsyncWithHttpInfo($id4n, $type, $private_routes = null, $public_routes = null)
    {
        $returnType = '\Swagger\Client\Model\Route';
        $request = $this->getRouteRequest($id4n, $type, $private_routes, $public_routes);
     ...
     */
    protected function getRouteRequest($id4n, $type, $private_routes = null, $public_routes = null)
    {
    ...
    {
        list($response) = $this->updateRoutingFileWithHttpInfo($rfr, $id4n);
        return $response;
    }
