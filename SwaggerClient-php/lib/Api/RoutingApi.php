...
class RoutingApi
{
     ...
     */
    public function getAllWebRoutes($id4n)
    {
        list($response) = $this->getAllWebRoutesWithHttpInfo($id4n);
        return $response;
    }

    /**
     * Operation getAllWebRoutesWithHttpInfo
     *
     * Retrieve all web routes
     *
     * @param  string $id4n id4n (required)
     ...
     */
    public function getAllWebRoutesWithHttpInfo($id4n)
    {
        $returnType = '\Swagger\Client\Model\Route[]';
        $request = $this->getAllWebRoutesRequest($id4n);
    ...
    /**
     * Operation getAllWebRoutesAsync
     *
     * Retrieve all web routes
     *
     * @param  string $id4n id4n (required)
     ...
     */
    public function getAllWebRoutesAsync($id4n)
    {
        return $this->getAllWebRoutesAsyncWithHttpInfo($id4n)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllWebRoutesAsyncWithHttpInfo
     *
     * Retrieve all web routes
     *
     * @param  string $id4n id4n (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebRoutesAsyncWithHttpInfo($id4n)
    {
        $returnType = '\Swagger\Client\Model\Route[]';
        $request = $this->getAllWebRoutesRequest($id4n);
    ...
    /**
     * Create request for operation 'getAllWebRoutes'
     *
     * @param  string $id4n id4n (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getAllWebRoutesRequest($id4n)
    {
        // verify the required parameter 'id4n' is set
        if ($id4n === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id4n when calling getAllWebRoutes'
            );
        }

        $resourcePath = '/api/v1/routingfiles/{id4n}/routes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  bool $interpolate interpolate (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Route
     */
    public function getRoute($id4n, $type, $private_routes = null, $public_routes = null, $interpolate = null)
    {
     ...
     * @return array of \Swagger\Client\Model\Route, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRouteWithHttpInfo($id4n, $type, $private_routes = null, $public_routes = null, $interpolate = null)
    {
        $returnType = '\Swagger\Client\Model\Route';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRouteAsync($id4n, $type, $private_routes = null, $public_routes = null, $interpolate = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRouteAsyncWithHttpInfo($id4n, $type, $private_routes = null, $public_routes = null, $interpolate = null)
    {
        $returnType = '\Swagger\Client\Model\Route';
        $request = $this->getRouteRequest($id4n, $type, $private_routes, $public_routes, $interpolate);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRouteRequest($id4n, $type, $private_routes = null, $public_routes = null, $interpolate = null)
    {
        // verify the required parameter 'id4n' is set
        if ($id4n === null) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/api/v1/routingfiles/{id4n}/routes/{type}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getRoutingFile($id4n, $organization_id = null)
    {
        list($response) = $this->getRoutingFileWithHttpInfo($id4n, $organization_id);
        return $response;
    }
     ...
     */
    public function getRoutingFileWithHttpInfo($id4n, $organization_id = null)
    {
        $returnType = '\Swagger\Client\Model\RoutingFile';
        $request = $this->getRoutingFileRequest($id4n, $organization_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoutingFileAsync($id4n, $organization_id = null)
    {
        return $this->getRoutingFileAsyncWithHttpInfo($id4n, $organization_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoutingFileAsyncWithHttpInfo($id4n, $organization_id = null)
    {
        $returnType = '\Swagger\Client\Model\RoutingFile';
        $request = $this->getRoutingFileRequest($id4n, $organization_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRoutingFileRequest($id4n, $organization_id = null)
    {
        // verify the required parameter 'id4n' is set
        if ($id4n === null) {
            throw new \InvalidArgumentException(
