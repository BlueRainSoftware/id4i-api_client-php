...
class OrganizationsApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PaginatedResponseOfCountry
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaginatedResponseOfCountry, HTTP status code, HTTP response headers (array of strings)
     */
    public function listCountriesWithHttpInfo($offset = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\PaginatedResponseOfCountry';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaginatedResponseOfCountry',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
