...
class PublicServicesApi
{
     ...
     */
    public function getWebRoutes($id4n)
    {
        list($response) = $this->getWebRoutesWithHttpInfo($id4n);
        return $response;
    }

    /**
     * Operation getWebRoutesWithHttpInfo
     *
     * Retrieve all public routes for a GUID
     *
     * @param  string $id4n id4n (required)
     ...
     */
    public function getWebRoutesWithHttpInfo($id4n)
    {
        $returnType = '\Swagger\Client\Model\Route[]';
        $request = $this->getWebRoutesRequest($id4n);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebRoutesAsync($id4n)
    {
        return $this->getWebRoutesAsyncWithHttpInfo($id4n)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWebRoutesAsyncWithHttpInfo
     *
     * Retrieve all public routes for a GUID
     *
     * @param  string $id4n id4n (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebRoutesAsyncWithHttpInfo($id4n)
    {
        $returnType = '\Swagger\Client\Model\Route[]';
        $request = $this->getWebRoutesRequest($id4n);
    ...
    /**
     * Create request for operation 'getWebRoutes'
     *
     * @param  string $id4n id4n (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebRoutesRequest($id4n)
    {
        // verify the required parameter 'id4n' is set
        if ($id4n === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id4n when calling getWebRoutes'
            );
        }
