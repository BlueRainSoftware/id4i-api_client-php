...
class GuidsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ImportGS1CodesRequest $import_gs1_codes_request The information how the MAPP codes should be imported and the list of MAPP codes (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
