...
/**
 * RemoveApiKeyPrivilegeRequest Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RemoveApiKeyPrivilegeRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemoveApiKeyPrivilegeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['privilege'] === null) {
            $invalid_properties[] = "'privilege' can't be null";
        }
