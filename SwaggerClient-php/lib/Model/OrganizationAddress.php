 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrganizationAddress implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['company_name']) && (strlen($this->container['company_name']) < 0)) {
            $invalid_properties[] = "invalid value for 'company_name', the character length must be bigger than or equal to 0.";
        }
        ...
        if ((strlen($this->container['firstname']) > 254)) {
            $invalid_properties[] = "invalid value for 'firstname', the character length must be smaller than or equal to 254.";
        }
        ...
        if ((strlen($this->container['lastname']) > 254)) {
            $invalid_properties[] = "invalid value for 'lastname', the character length must be smaller than or equal to 254.";
        }
        ...
        if ((strlen($this->container['post_code']) > 40)) {
            $invalid_properties[] = "invalid value for 'post_code', the character length must be smaller than or equal to 40.";
        }
        ...
        if (!is_null($this->container['telephone']) && (strlen($this->container['telephone']) < 0)) {
            $invalid_properties[] = "invalid value for 'telephone', the character length must be bigger than or equal to 0.";
        }
